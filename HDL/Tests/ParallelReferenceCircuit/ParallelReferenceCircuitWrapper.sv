`ifndef PARALLEL_REFERENCE_CIRCUIT_WRAPPER
 `define PARALLEL_REFERENCE_CIRCUIT_WRAPPER

module ParallelReferenceCircuitWrapper #(
...
ParrallelReferenceCircuitLayer #(
